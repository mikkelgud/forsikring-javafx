...
public class ClaimInsuranceValidator {
    ...
    public ClaimInsurance createNewClaimInsurance(String currentPersonId, String damageType, String dateOfRegistration, String descriptionOfDamage, String taxationValue, String witnesses, String moneyBack) throws InvalidClaimRegistrationException {
        ...
        return new ClaimInsurance(currentPersonId, damageType, dateOfRegistration, descriptionOfDamage, taxationValue, witnesses, moneyBack);
    }
